...
public interface Storage {
     ...
     *             If the file cannot be found or the path refers to a directory.
     * @throws RMIException
     ...
     *            Path to the file.
     * @param offset
     *            Offset into the file to the beginning of the sequence.
     * @param length
     *            The number of bytes to be read.
     * @return An array containing the bytes read. If the call succeeds, the number of bytes read is equal to the number of bytes
     *         requested.
     * @throws IndexOutOfBoundsException
     *             If the sequence specified by <code>offset</code> and <code>length</code> is outside the bounds of the file, or
     *             if <code>length</code> is negative.
     * @throws FileNotFoundException
     *             If the file cannot be found or the path refers to a directory.
     * @throws IOException
     *             If the file read cannot be completed on the server.
     * @throws RMIException
     *             If the call cannot be completed due to a network error.
     */
    public byte[] read(Path file, long offset, int length) throws RMIException, FileNotFoundException, IOException;
     ...
     *            Path to the file.
     * @param offset
     *            Offset into the file where data is to be written.
     * @param data
     ...
     *             If the file cannot be found or the path refers to a directory.
     * @throws IOException
     *             If the file write cannot be completed on the server.
     * @throws RMIException
     *             If the call cannot be completed due to a network error.
     */
