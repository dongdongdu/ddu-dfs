 ...
 * 
 * <p>
 * This application takes a list of remote paths, and attempts to delete the files and directories named by those paths. Directory
...
public class Remove extends ClientApplication {
    ...
    private void remove(String remote_path) throws ApplicationFailure {
        ...
        try {
            ...
            throw new ApplicationFailure("cannot lock " + object.parent() + ": " + t.getMessage());
        }
        ...
        try {
            ...
            throw new ApplicationFailure("cannot delete " + object + ": " + t.getMessage());
        } finally {
