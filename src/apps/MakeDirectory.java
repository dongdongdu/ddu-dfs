 ...
 * 
 * <p>
 * This application takes a list of remote directories as arguments, and attempts to create each one.
 */
public class MakeDirectory extends ClientApplication {
     ...
     *            Remote path to the directory that is to be created.
    ...
    private void make(String remote_directory) throws ApplicationFailure {
        ...
        try {
            ...
            throw new ApplicationFailure("cannot lock " + directory.parent() + ": " + t.getMessage());
        }
        ...
        try {
            ...
            throw new ApplicationFailure("cannot create directory " + directory + ": " + t.getMessage());
        } finally {
            // In all cases, make an effort to unlock the parent directory.
            try {
                naming_server.unlock(parent, true);
            } catch (Throwable t) {
                fatal("could not unlock " + directory.parent() + ": " + t.getMessage());
            }
        }
    }
}
