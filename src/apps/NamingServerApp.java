 ...
 * 
 * <p>
 * The naming server application does not take any arguments. It starts a naming server listening on the default client and
 * registration ports for clients and storage servers, respectively.
 */
public class NamingServerApp extends ServerApplication {
     ...
     * @throws RMIException
     *             If the naming server cannot be started.
     */
    @Override
    protected void startServer(String[] arguments) throws BadUsageException, RMIException {
