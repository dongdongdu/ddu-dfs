 ...
 * 
 * <p>
 * The working directory is simply <code>$DFSHOST:$DFSCWD</code>, if these variables are both defined. If <code>DFSCWD</code> is
 * not defined, the default value used is the root directory (<code>/</code>).
 */
public class PrintWorkingDirectory extends ClientApplication {
    ...
    public void coreLogic(String[] arguments) throws ApplicationFailure {
        ...
        try {
            ...
            throw new ApplicationFailure("cannot obtain current working " + "directory: " + e.getMessage());
        }
    }
}
