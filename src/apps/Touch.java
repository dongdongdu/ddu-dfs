 ...
 * 
 * <p>
 * This application takes a list of remote files as arguments. For each remote file that does not exist, the application attempts
 * to create it.
 */
public class Touch extends ClientApplication {
     ...
     *             If the file does not yet exist and cannot be created.
     */
    private void touch(String remote_file) throws ApplicationFailure {
        ...
        try {
            ...
            throw new ApplicationFailure("cannot lock " + file.parent() + ": " + t.getMessage());
        }
        ...
        try {
            ...
            throw new ApplicationFailure("cannot access " + file + ": " + t.getMessage());
        } finally {
            // Make an effort to unlock the parent directory.
            try {
                naming_server.unlock(parent, true);
            } catch (Throwable t) {
                fatal("could not unlock " + file.parent() + ": " + t.getMessage());
            }
        }
    }
}
